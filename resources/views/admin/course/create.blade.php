...
<div class="main-content group-data-[sidebar-size=lg]:xl:ml-[calc(theme('spacing.app-menu')_+_16px)] group-data-[sidebar-size=sm]:xl:ml-[calc(theme('spacing.app-menu-sm')_+_16px)] px-4 group-data-[theme-width=box]:xl:px-0 ac-transition">
    ...
    <div class="pb-4">
        <form id="msform" name="msform" action="{{ route('course.store') }}" method="POST" class="*:hidden" enctype="multipart/form-data">
                ...
                <div class="card p-4 lg:p-6">
                    ...
                    <div class="grid grid-cols-2 gap-x-4 gap-y-5 mt-7 pt-0.5">
                        <div class="col-span-full lg:col-auto leading-none">
                            ...
                            <input type="text" id="courseTitle" name="courseTitle" placeholder="Course Title" class="form-input" autocomplete="off">
                        ...
                        <div class="col-span-full lg:col-auto leading-none">
                            ...
                            <select class="multiSelect" name="instructor" id="instructor">
                        ...
                        <div class="col-span-full lg:col-auto leading-none">
                            ...
                            <input type="number" id="price" name="price" placeholder="Course Price" class="form-input" autocomplete="off" >
                        ...
                        <div class="col-span-full lg:col-auto leading-none">
                            ...
                            <input type="text" id="courseDuration" name="courseDuration" class="form-input" >
                            <span class="text-xs leading-none text-gray-900 dark:text-dark-text mt-2">
                        ...
                        <div class="col-span-full">
                            ...
                            <textarea name="overview" id="overview" class="summernote"></textarea>
...
<script type="text/javascript">
    ...
    $("#msform").submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("course.store") }}', // Update the URL to match course store route
            type: "POST",
